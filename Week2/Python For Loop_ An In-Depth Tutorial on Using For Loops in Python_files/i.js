...
if (!bouncex) { 	var bouncex = {};
	...
	var bcx_init = function(){
		...
		if(!bouncex.visit_cookie){
			...
			bouncex.visit_cookie.lp = bouncex.calling_url.substring(0,500).replace(/\+/g,'%2B');
