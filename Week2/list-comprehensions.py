...
r = [first[0] + ". " + last for first,last in zip(a,b)]
...
#r = [[letter for letter in a] + [number for number in b]] 	prints [a,b,c,1,2,3]
#r = [letter + number for letter,number in zip(a,b)] 		prints [a1,b2,c3]
r = [letter + number for letter in a for number in b] 	
